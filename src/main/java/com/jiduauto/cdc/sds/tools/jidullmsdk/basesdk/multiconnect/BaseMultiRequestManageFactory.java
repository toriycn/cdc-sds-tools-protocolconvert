...
public class BaseMultiRequestManageFactory{
    ...
    public int sendRequest(String url ,String asrSn,Object requestJson){
        int state = 0 ;
        try{
            SDKLogUtil.log("BaseMultiRequestManageFactory client sendRequest:"+asrSn+";requestJson="+requestJson);
            ...
            state = baseMultiRequestManage.sendRequest(asrSn,requestJson);
            SDKLogUtil.log("BaseMultiRequestManageFactory client sendRequest Result,state"+ state+";url="+url+";asrSn:"+asrSn+";requestJson="+requestJson);
        }catch (Exception ex){
            SDKLogUtil.log("BaseMultiRequestManageFactory client sendRequest:"+asrSn+";requestJson="+requestJson+";exception:"+ex.getMessage());
            ex.printStackTrace();
        }
        return state;
    }
    ...
    public void enSession(String url,String sessionId){
        if(wsHashMap.containsKey(url))
        {
